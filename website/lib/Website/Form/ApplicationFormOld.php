...
class ApplicationForm extends BaseForm
{
    public function init()
    {
        ...
        $this->setupThePositionForm($formName, $careHomeOptions, $positions, $shifts, $howDidYouHear);
     ...
     */
    private function setupThePositionForm($formName, $careHomeOptions, $positions, $shifts, $howDidYouHear)
    {
        ...
        $howDidYouHear->setMultiOptions($howDidYouHear)
            ->setRequired(true)
