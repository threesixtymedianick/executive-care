...
<?php endif; ?>
    ...
    <div class="sidebar__job-alerts">
        ...
        <form action="//execcaregroup.us6.list-manage.com/subscribe/post?u=4540541692bd0d70b7d94231e&amp;id=0fa2f6e5ba"
            ...
            <div style="position: absolute; left: -5000px;"><input type="text"
                                                                   name="b_4540541692bd0d70b7d94231e_0fa2f6e5ba"
                                                                   tabindex="-1" value=""></div>
            <div class="clear">
                <button class="signup-btn" type="submit" role="button" id="mc-embedded-subscribe">Sign up</button>
            </div>
        </form>
    </div>
